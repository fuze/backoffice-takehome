...
CREATE TABLE IF NOT EXISTS takeHome.user_department (  
  ...
  CONSTRAINT fk_user_department_user1
    ...
    ON DELETE CASCADE,
  CONSTRAINT fk_user_department_department1
    FOREIGN KEY (department_id)
    REFERENCES takeHome.departments (id)
    ON DELETE CASCADE);

CREATE INDEX IF NOT EXISTS fk_user_department_user1_idx ON takeHome.users (id ASC);
CREATE INDEX IF NOT EXISTS fk_user_department_department1_idx ON takeHome.departments (id ASC);
